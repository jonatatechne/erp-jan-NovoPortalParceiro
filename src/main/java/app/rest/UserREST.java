...
public class UserREST {
  ...
  public HttpEntity<PagedResources<User>> findUsersByParceiro(@PathVariable("parceiroId") java.lang.String parceiroId, Pageable pageable, PagedResourcesAssembler assembler) {
    return new ResponseEntity<>(assembler.toResource(userBusiness.findUsersByParceiro(parceiroId, pageable)), HttpStatus.OK);
  }
}
